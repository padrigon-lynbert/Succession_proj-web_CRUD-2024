<?php // update.php
    ...
    if (isset($_GET['updateid'])) {
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE `employee` SET fname=?, lname=?, current_position=?, promotion_to=? WHERE id=?";

            // Prepare and bind parameters
            $stmt = mysqli_prepare($connection, $sql);
            mysqli_stmt_bind_param($stmt, "ssssi", $fname, $lname, $current_position, $promotion_to, $id);
